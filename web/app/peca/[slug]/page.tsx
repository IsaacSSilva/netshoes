  ...
  return (
    <>
      <section className='w-full h-screen flex justify-center items-center'>
        <section className='max-w-[1800px] h-full m-auto flex justify-center items-center md:flex-row flex-col gap-5'>
          ...
          <section className='md:w-1/3 gap-5 w-full md:m-auto md:mx-5 flex flex-col justify-center  items-center'>
            ...
            <div className='font-inter md:block hidden border border-black p-5 space-y-2 space-x-0.5 rounded'>
          ...
          {/* <section className='md:flex hidden w-1/5 py-10 px-2.5 justify-center md:items-end '></section> */}
